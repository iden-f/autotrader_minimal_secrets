...
CAR = Listing(id="1", url="https://example.invalid/car", title="2019 BMW M3",
              price=72000, price_source="detail", search_id="s")


def a_change(kind: str, **kw) -> Change:
    return Change(kind, CAR, old_price=80000, new_price=72000, **kw)
