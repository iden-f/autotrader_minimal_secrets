...
class Dead(Notifier):
    """A channel whose credentials are rejected, exactly like the real one."""
    name = "email"
...
class TestRetirement:
    ...
    <a href="/a/bmw/m5/ottawa/ontario/{listing_id}/">
      <h2>2023 BMW M5 Competition</h2>
      <span class="odometer-proximity">12,400 km</span>
      <span class="price-amount">$142,000</span>
    </a></div>'''
