...
The timeline below is the real one, rounded to the minute.
"""
...
class TestTheSilenceAlarmKnowsWhichSilenceItIs:
    def test_a_thin_schedule_is_named_as_one(self, watcher):
        ...
        assert "KEEPING-TIME.md" in said["body"]
