...
class TestComparison:
    ...
    def test_the_description_is_readable(self):
        ...
        text = describe("BMW M5", reasons, shot(strategy="regex"))
        assert "BMW M5" in text and "regex" in text
...
class TestFingerprint:
    def test_the_real_platform_page_is_recognised(self, fixture_html):
        ...
        result = parse_search_page(html, "https://www.autotrader.ca/cars/bmw/m5")
