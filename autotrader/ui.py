...
from disk it stays read-only and offers copy/download instead.  One file, two
modes, no build step and no framework.
"""
...
def _handler(config_path: Path, state_path: Path):
    class Handler(BaseHTTPRequestHandler):
        ...
        def _send(self, status: int, body: bytes, content_type: str) -> None:
            ...
            # This server is bound to localhost and edits local files; refuse
            # to be embedded or read cross-origin by a page in another tab.
